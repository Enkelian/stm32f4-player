...
static void f_disp_res(FRESULT r)
{
	switch(r)
	{
		case FR_OK: xprintf("FR_OK\n"); break;
		case FR_DISK_ERR: xprintf("FR_DISK_ERR\n"); break;
		case FR_INT_ERR: xprintf("FR_INT_ERR\n"); break;
		case FR_NOT_READY: xprintf("FR_NOT_READY\n"); break;
		case FR_NO_FILE: xprintf("FR_NO_FILE\n"); break;
		case FR_NO_PATH: xprintf("FR_NO_PATH\n"); break;
		case FR_INVALID_NAME: xprintf("FR_INVALID_NAME\n"); break;
		case FR_DENIED: xprintf("FR_DENIED\n"); break;
		case FR_EXIST: xprintf("FR_EXIST\n"); break;
		case FR_INVALID_OBJECT: xprintf("FR_INVALID_OBJECT\n"); break;
		case FR_WRITE_PROTECTED: xprintf("FR_WRITE_PROTECTED\n"); break;
		case FR_INVALID_DRIVE: xprintf("FR_INVALID_DRIVE\n"); break;
		case FR_NOT_ENABLED: xprintf("FR_NOT_ENABLED\n"); break;
		case FR_NO_FILESYSTEM: xprintf("FR_NO_FILESYSTEM\n"); break;
		case FR_MKFS_ABORTED: xprintf("FR_MKFS_ABORTED\n"); break;
		case FR_TIMEOUT: xprintf("FR_TIMEOUT\n"); break;
		case FR_LOCKED: xprintf("FR_LOCKED\n"); break;
		case FR_NOT_ENOUGH_CORE: xprintf("FR_NOT_ENOUGH_CORE\n"); break;
		case FR_TOO_MANY_OPEN_FILES: xprintf("FR_TOO_MANY_OPEN_FILES\n"); break;
		case FR_INVALID_PARAMETER: xprintf("FR_INVALID_PARAMETER\n"); break;
		default: xprintf("result code unknown (%d = 0x%X)\n",r,r);
	}
}
...
void StartDefaultTask(void const * argument)
{
  ...
  HAL_GPIO_WritePin(OTG_FS_PowerSwitchOn_GPIO_Port, OTG_FS_PowerSwitchOn_Pin, GPIO_PIN_RESET);
    ...
    res = f_open(&file,"0:/barka.wav",FA_READ);
